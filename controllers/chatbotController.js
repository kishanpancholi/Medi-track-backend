...
const prompt = `
You are Medi-Track AI Assistant — a smart healthcare chatbot built into the Medi-Track patient portal.
...
`;
  ...
  if (status === 429) {
    return res.status(429).json({
      reply: "AI is busy. Please try again in a few seconds."
    });
  }

  return res.status(500).json({
    reply: "Something went wrong with AI. Please try again."
  });
}
};
...
//     • Stomach/digestion → Gastroenterologist
// - NEVER give a serious diagnosis
// - If symptoms are dangerous say: "⚠️ Seek immediate medical help or call emergency services."
// - Always end health advice by suggesting to consult a doctor
// - ALWAYS remember previous messages in the conversation and reply accordingly
...
// 3. Select a Doctor, Date & Time
// 4. Select type: Video Call 🎥 or Physical Visit 🏥
// 5. Confirm — it appears under "Upcoming Appointment"

// 🔍 HOW TO FIND THE RIGHT DOCTOR:
// - Use "Find a Doctor" section on dashboard
// - Filter by Specialization, Experience, Availability, Rating
// - Click "View Details" → then "Book Appointment"

// 🎥 HOW VIDEO CALL WORKS:
// - Book a "Video Call" appointment
// - "Join Call" button appears 10 min before appointment
// - Call available for 30 minutes

// 💊 PRESCRIPTIONS: Click "Prescriptions" card on dashboard
// 📄 UPLOAD RECORDS: Click "Upload Records" card on dashboard
// ⭐ REVIEWS: Click "Write a Review" in the reviews section
